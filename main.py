...
# bot
bot_token = os.environ.get("TOKEN", "5740728171:AAGorh7Ef8UnhtwdvuWSOzX9DlKVBQZmWpE")
...
def send_start(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
    ...
    reply_markup=InlineKeyboardMarkup([[ InlineKeyboardButton("🌐 ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇs", url="https://t.me/Hollywood_in_HindiHD")]]), reply_to_message_id=message.id)
